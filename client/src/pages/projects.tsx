    ...
    <div className="min-h-screen bg-lumon-dark text-text-cyan p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 text-center">
          ...
          <Link to="/" className="inline-block mt-4 px-6 py-2 border border-cyan-soft text-cyan-soft rounded hover:bg-cyan-soft hover:text-lumon-dark transition-colors">
            Return to Terminal
          </Link>
        </div>
      </div>
