...
export default function ProjectsGridPane() {
  ...
  const cards = projects.map((project, index) => ({
    ...
    thumbnail: project.image || "https://images.unsplash.com/photo-1518709268805-4e9042af2176?q=80&w=500&auto=format&fit=crop"
  }));

  return (
    <div className="pane-border rounded-lg overflow-hidden flex flex-col h-full" aria-label="Projects Grid">
      {/* Pane Header */}
